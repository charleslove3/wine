...
function handleSubmit(event) {
      ...
      const completionPayload = {
        model: "gpt-3.5-turbo",
        messages: [
          {"role": "user", "content": `${descr}. Please provide three wine recommendations, following this format for each recommendation:
...
- Do not use the word "Recommendation" in any of the three recommendations.
